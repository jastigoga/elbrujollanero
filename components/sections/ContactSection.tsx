    ...
    <section id="contacto" className="relative py-28">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(201,162,75,0.06) 0%, transparent 70%)",
          }}
        />
      </div>
      ...
      <div className="relative mx-auto max-w-4xl px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {/* WhatsApp CTA — centered, with decorative ring */}
          <motion.div
          ...
          >
            ...
            <div className="relative">
              <div className="absolute inset-0 rounded-full border border-whatsapp/20 scale-[2.2] opacity-30" />
              <div className="absolute inset-0 rounded-full border border-whatsapp/15 scale-[1.6] opacity-20" />
              <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-whatsapp/10">
                <svg
                  width="28"
                  height="28"
                  viewBox="0 0 24 24"
            ...
            <div>
              ...
              <p className="font-voice text-sm text-ivory-dim">
                La forma más rápida de comunicarte.
                <br />
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full bg-whatsapp px-8 py-3.5 font-ui text-sm font-semibold text-whatsapp-on shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:bg-whatsapp-dark hover:shadow-xl"
            >
          ...
          <div className="flex flex-col gap-4 justify-center">
            {[
              ...
              <motion.div
                ...
                className="flex items-start gap-4 rounded-xl border border-border bg-carbon/30 p-5 transition-all duration-200 hover:border-white/10"
